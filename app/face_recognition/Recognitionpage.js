...
const fetchImagesFromS3 = async (nameValue, relationValue) => {
  ...
  try {
    ...
    const response = await Storage.list(`Memory/pavani/${relationValue}/${nameValue}/`);
...
const fetchPatientDetails =  (filenm) => {
    ...
    const res =  axios.get(`https://bgin35dpfio3nrpnz3gvgctwei0qqiot.lambda-url.us-east-1.on.aws/api?inputfname=${filenm}&token=RRshJy4beYdlNbu&personname=pavani`)
    .then(async (res) => {
